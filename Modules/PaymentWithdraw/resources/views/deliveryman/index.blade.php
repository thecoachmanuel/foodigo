                                                ...
                                                <tr class="odd">
                                                    ...
                                                    <td class="crancy-table__column-2 crancy-table__data-2">
                                                        <h4 class="crancy-table__product-title">
                                                            <a href="{{ route('admin.deliveryman-show', $withdraw->deliveryman_id) }}">{{ $withdraw?->deliveryman?->fname }}</a>
                                                        </h4>
                                                    </td>
                                                    ...
                                                    <td class="crancy-table__column-2 crancy-table__data-2">
                                                        <a href="{{ route('admin.deliveryman-withdraw-list.show', $withdraw->id) }}" class="crancy-btn"><i class="fas fa-eye"></i> {{ __('translate.View') }}</a>
...
@push('js_section')
    <script>
        ...
        function itemDeleteConfrimation(id){
            $("#item_delect_confirmation").attr("action",'{{ url("admin/deliveryman-withdraw-list/") }}'+"/"+id)
        }
    </script>
@endpush
