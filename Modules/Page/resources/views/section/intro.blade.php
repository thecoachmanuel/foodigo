                                            ...
                                            <div class="row">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="crancy__item-form--group w-100 h-100">
                                                                <label class="crancy__item-label">{{ __('translate.Image') }} </label>
                                                                <div class="crancy-product-card__upload crancy-product-card__upload--border">
                                                                    <input type="file" class="btn-check" name="intro_banner_two" id="input-img2" autocomplete="off" onchange="previewImage2(event)">
                                                                    <label class="crancy-image-video-upload__label" for="input-img2">
                                                                        <img class="intro_imagee" id="view_img2" src="{{ asset($homepage->intro_banner_two) }}">
                                                                        <h4 class="crancy-image-video-upload__title">{{ __('translate.Click here to') }} <span class="crancy-primary-color">{{ __('translate.Choose File') }}</span> {{ __('translate.and upload') }} </h4>
                                                                    </label>
                                                                </div>
                                                            </div>
                                                ...
                                                <div class="col-12">
                                                    <div class="crancy__item-form--group mg-top-form-20">
                                                        ...
                                                        <input class="crancy__item-input tags" type="text" name="intro_tags" id="intro_tags" value="{{ $translate->intro_tags }}">
                                                    </div>
                                                </div>
