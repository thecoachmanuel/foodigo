...
@section('title')
    <title>{{ __('translate.Edit Addon') }}</title>
@endsection

@section('body-header')
    <h3 class="crancy-header__title m-0">{{ __('translate.Edit Addon') }}</h3>
    <p class="crancy-header__text">{{ __('translate.Manage Product') }} >> {{ __('translate.Edit Addon') }}</p>
@endsection
                                        ...
                                        <div class="translation_box">
                                            <ul>
                                                @foreach ($language_list as $language)
                                                    <li>
                                                        <a href="{{ route('admin.addon.edit', ['addon' => $addon->id, 'lang_code' => $language->lang_code] ) }}">
                    ...
                    <div class="crancy-body">
                        ...
                        <div class="crancy-dsinner">
                            <form action="{{ route('admin.addon.update', $addon->id) }}" method="POST"
                                ...
                                <input type="hidden" name="lang_code" value="{{ $addon_translate->lang_code }}">
                                <input type="hidden" name="translate_id" value="{{ $addon_translate->id }}">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="crancy-product-card">
                                            <div class="create_new_btn_inline_box">
                                                <h4 class="crancy-product-card__title">{{ __('translate.Edit Addon') }}</h4>

                                                <a href="{{ route('admin.addon.index') }}" class="crancy-btn "><i
                                                        class="fa fa-list"></i> {{ __('translate.Addon List') }}</a>
                                            </div>
                                                ...
                                                <div class="col-12">
                                                    <div class="crancy__item-form--group mg-top-form-20">
                                                        ...
                                                        <input class="crancy__item-input" type="text" name="name"
                                                               id="name" value="{{ $addon_translate->name }}">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-12">
                                                    <div class="crancy__item-form--group mg-top-form-20">
                                                        ...
                                                        <input class="crancy__item-input" type="number" name="price"
                                                               id="price" value="{{ $addon->price }}">
                                                    </div>
                                                </div>

                                                <div class="col-12">
                                                    <div class="crancy__item-form--group mg-top-form-20">
                                                        <label class="crancy__item-label">{{ __('translate.Restaurant') }} * </label>
                                                        <select class="form-select crancy__item-input" name="restaurant_id" required>
                                                            <option value="">{{ __('translate.Select Restaurant') }}</option>
                                                            @foreach ($restaurants as $restaurant)
                                                                <option {{ $restaurant->id == $addon->restaurant_id ? 'selected' : '' }} value="{{ $restaurant->id }}">{{ $restaurant->restaurant_name }}</option>
                                                            @endforeach
                                                        ...
                                                        <div class="crancy__item-form--group mg-top-form-20">
                                                            ...
                                                            <div
                                                                ...
                                                                <label class="crancy__item-switch">
                                                                    <input
                                                                        {{ $addon->status == 'enable' ? 'checked' : '' }} name="status"
                                                                        type="checkbox">
                                                                    <span
