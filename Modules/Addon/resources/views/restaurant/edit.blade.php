                                        ...
                                        <div class="translation_box">
                                            <ul>
                                                @foreach ($language_list as $language)
                                                    <li>
                                                        <a href="{{ route('restaurant.addon.edit', ['addon' => $addon->id, 'lang_code' => $language->lang_code] ) }}">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="crancy-body">
                        <!-- Dashboard Inner -->
                        <div class="crancy-dsinner">
                            <form action="{{ route('restaurant.addon.update', $addon->id) }}" method="POST"
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="crancy-product-card">
                                            <div class="create_new_btn_inline_box">
                                                ...
                                                <a href="{{ route('restaurant.addon.index') }}" class="crancy-btn "><i
