                                    ...
                                    <div class="crancy-psidebar">
                                        ...
                                        <div class="list-group crancy-psidebar__list" id="list-tab" role="tablist">
                                            ...
                                            <a class="list-group-item" data-bs-toggle="list" href="#id4" role="tab" aria-selected="false"><span class="crancy-psidebar__icon">
                                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M7.00024 18V16M12.0002 18V15M17.0002 18V13" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                                    ...
                                                    <path d="M15.0002 6H18.0002V9M6.00024 12C13.0002 12 17.5002 6.5 17.5002 6.5" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                                    </svg>
                                            ...
                                            <a class="list-group-item" data-bs-toggle="list" href="#id6" role="tab" aria-selected="false"><span class="crancy-psidebar__icon">
                                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M19.5 2.5C20.6046 2.5 21.5 3.39543 21.5 4.5V19.5C21.5 20.6046 20.6046 21.5 19.5 21.5H4.5C3.39543 21.5 2.5 20.6046 2.5 19.5V4.5C2.5 3.39543 3.39543 2.5 4.5 2.5H19.5Z" stroke="currentColor" stroke-width="1.5" stroke-linejoin="round"/>
                                                    <path d="M17.0001 7.5H14.0006C12.8931 7.5 11.9965 8.39996 12.0006 9.50742L12.0154 13.4995M12.0154 13.4995V21.5M12.0154 13.4995H10.0001M12.0154 13.4995H15" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                                    </svg>
                                                                        ...
                                                                        <div class="crancy__item-group">
                                                                            ...
                                                                            <div class="crancy__item-form--group">
                                                                                <div class="row">
                                                                                    ...
                                                                                    <div class="col-12">
                                                                                        <div class="crancy__item-form--group mg-top-form-20">
                                                                                            <label class="crancy__item-label">{{ __('translate.Preloader') }} * </label>
                                                                                    ...
                                                                                    <div class="crancy__item-form--group mg-top-form-20">
                                                                                        <label class="crancy__item-label">{{ __('translate.Seller Commission per delivery (%)') }} </label>
                                                                                        <input class="crancy__item-input" type="text" value="{{ $general_setting->commission_per_sale }}" name="commission_per_sale">
                                                                                    </div>

                                                                                    <div class="crancy__item-form--group mg-top-form-20">
                                                                                        <label class="crancy__item-label">{{ __('translate.Delivery Commission per delivery (%)') }} </label>
                                                                                        <input class="crancy__item-input" type="text" value="{{ $general_setting->commission_per_delivery }}" name="commission_per_delivery">
                                                                                    </div>
                                                                                    ...
                                                                                    <div class="col-12">
                                                                                        <div class="crancy__item-form--group mg-top-form-20">
                                                                                            <label class="crancy__item-label">{{__('translate.Per kilometer delivery charge')}} </label>
                                                                                            <input class="crancy__item-input" type="text" value="{{ $general_setting->delivery_charge }}" name="delivery_charge">
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                                        ...
                                                                                        <div class="row">
                                                                                            <div class="col-md-4">
                                                                                                <div class="crancy__item-form--group mg-top-20">
                                                                                                    ...
                                                                                                    <div class="crancy-product-card__upload crancy-product-card__upload--border">
                                                                                                        <input type="file" class="btn-check" name="footer_logo" id="input_footer_logo" autocomplete="off" onchange="viewFooterLogo(event)">
                                                                                                        <label class="crancy-image-video-upload__label" for="input_footer_logo">
                                                                                                            <img id="footer_logo_view" src="{{ asset($general_setting->footer_logo) }}" class="home2_explore_img">
                                                                                                            <h4 class="crancy-image-video-upload__title">{{ __('translate.Click here to') }} <span class="crancy-primary-color">{{ __('translate.Choose File') }}</span> {{ __('translate.and upload') }} </h4>
                                                                                                        </label>
                                                                                                    </div>
                                                                                                </div>
...
@push('js_section')
    <script>
        ...
        function viewFooterLogo(event) {

            var reader = new FileReader();
            reader.onload = function(){
                var output = document.getElementById('footer_logo_view');
