                    ...
                    <div class="row mb-4">
                        <div class="col-12">
                            <div class="zum_icvoice_item_main">
                                ...
                                <div id="restaurant_order_details_map" style="height: 280px; width: 100%; border-radius: 12px; border: 1.5px solid #cbd5e1; z-index: 1;"></div>
                            </div>
                        </div>
                    </div>
...
@push('js_section')
    ...
    <script>
        ...
        document.addEventListener("DOMContentLoaded", function() {
            ...
            let initialLat = origLat || destLat || 7.4250;
            let initialLng = origLng || destLng || 3.9050;
            ...
            if (destLat !== 0 && destLng !== 0) {
                ...
                destMarker.bindPopup(`<b>{{ __('translate.Delivery Destination') }}</b><br><small>{{ addslashes($addressObj?->address ?? '') }}</small>`);
