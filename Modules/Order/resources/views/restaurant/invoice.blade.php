        ...
        <div class="container container__bscreen">
            <div class="crancy-product-card p-4 p-md-5 bg-white rounded shadow-sm">
                ...
                <div class="d-flex justify-content-between align-items-center mb-4 no-print">
                    <a href="{{ route('restaurant.order.details', $order->id) }}" class="crancy-btn btn-secondary">
                ...
                <div class="row pb-4 border-bottom mb-4 align-items-center">
                    <div class="col-sm-6">
                        ...
                        <p class="text-muted mb-0">{{ $order->restaurant?->restaurant_name ?? config('app.name') }}</p>
                    </div>
                ...
                <div class="mt-5 text-center text-muted small border-top pt-3">
                    <p class="mb-0">{{ __('translate.Thank you for choosing') }} {{ $order->restaurant?->restaurant_name ?? config('app.name') }}.</p>
                </div>
            </div>
        </div>
    </section>
