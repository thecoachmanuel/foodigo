                                        ...
                                        <tbody class="crancy-table__body">
                                            @foreach ($blog_comments as $index => $blog_comment)
                                                <tr class="odd">
                                                    ...
                                                    <td class="crancy-table__column-2 crancy-table__data-2">
                                                    <a target="_blank" class="btn btn-success btn-sm" href="{{ route('blog.details', $blog_comment?->blog?->slug) }}" >{{ __('translate.Click Here') }}</a>
                                                    </td>
                                                    ...
                                                    <td class="crancy-table__column-2 crancy-table__data-2">
                                                        <a href="{{ route('admin.show-comment', $blog_comment->id) }}" class="crancy-btn"><i class="fas fa-eye"></i> {{ __('translate.View') }}</a>
