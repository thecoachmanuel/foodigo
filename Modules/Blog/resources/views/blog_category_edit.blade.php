                                    ...
                                    <div class="crancy-product-card translation_main_box">
                                        ...
                                        <div class="translation_box">
                                            <ul >
                                                ...
                                                <li><a href="{{ route('admin.blog-category.edit', ['blog_category' => $blog_category->id, 'lang_code' => $language->lang_code] ) }}">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="crancy-product-card">
                                            <div class="create_new_btn_inline_box">
                                                ...
                                                <a href="{{ route('admin.blog-category.index') }}" class="crancy-btn "><i class="fa fa-list"></i> {{ __('translate.Category List') }}</a>
                                            </div>
