                                            ...
                                            <div class="col-md-6">
                                                <div class="crancy__item-form--group mg-top-form-20">
                                                    ...
                                                    <div class="position-relative w-100">
                                                        <input id="searchMapInput" class="crancy__item-input" type="text" placeholder="{{ __('translate.Search area, street, or estate...') }}" value="{{ $restaurant->address }}" autocomplete="off" style="font-weight: 600;">
                                                    </div>
                                            ...
                                            <div class="col-md-6 col-12">
                                                <div class="crancy__item-form--group mg-top-form-20">
                                                    ...
                                                    <div class="position-relative">
                                                        <input class="crancy__item-input has-password-toggle" type="password" name="password" id="password" placeholder="{{ __('translate.Enter new password') }}">
                                            ...
                                            <div class="col-md-6">
                                                <div class="crancy__item-form--group mg-top-form-20">
                                                    ...
                                                    <select class="form-select crancy__item-input" name="is_banned">
                                                        <option value="disable" {{ $restaurant->is_banned != 'enable' ? 'selected' : '' }}>{{ __('translate.Active') }}</option>
                                                        <option value="enable" {{ $restaurant->is_banned == 'enable' ? 'selected' : '' }}>{{ __('translate.Banned') }}</option>
                                                    </select>
                                                </div>
                                            </div>
...
@push('js_section')
    ...
    <script>
        ...
        document.addEventListener("DOMContentLoaded", function() {
            let defaultLat = parseFloat("{{ $restaurant->latitude ?? old('latitude', '7.4250') }}") || 7.4250;
            let defaultLng = parseFloat("{{ $restaurant->longitude ?? old('longitude', '3.9050') }}") || 3.9050;
            ...
            @if($restaurant->address)
                marker.bindPopup(`<b>{{ addslashes($restaurant->address) }}</b>`).openPopup();
            @endif
