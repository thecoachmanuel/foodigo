...
class MenuItemController extends Controller
{
    ...
    public function create(Menu $menu)
    {
        $frontendRoutes = [
            ...
            // Restaurant Related
            ['name' => 'All Restaurants', 'route' => '/all-restaurant'],
            ['name' => 'Cuisines', 'route' => '/cuisines'],
            ['name' => 'Apply for Restaurant', 'route' => '/apply-restaurant'],

            // Search & Discovery
            ['name' => 'Search', 'route' => '/search'],
            ['name' => 'Offers & Deals', 'route' => '/offer'],
            ...
            ['name' => 'User Register', 'route' => '/register'],
            ['name' => 'User Dashboard', 'route' => '/user/dashboard'],
            ['name' => 'User Profile', 'route' => '/user/edit-profile'],
            ['name' => 'User Orders', 'route' => '/user/orders'],
            ['name' => 'User Address', 'route' => '/user/address'],
            ['name' => 'User Reviews', 'route' => '/user/review'],

            // Restaurant Account Pages
            ['name' => 'Restaurant Login', 'route' => '/restaurant/login'],
            ['name' => 'Restaurant Dashboard', 'route' => '/restaurant/dashboard'],
            ['name' => 'Restaurant Profile', 'route' => '/restaurant/profile'],

            // Delivery Man Pages
            ['name' => 'Delivery Man Login', 'route' => '/deliveryman/login'],
            ['name' => 'Delivery Man Dashboard', 'route' => '/deliveryman/dashboard'],
            ...
            // Additional Pages
            ['name' => 'Currency Switcher', 'route' => '/currency-switcher'],
            ['name' => 'Language Switcher', 'route' => '/lang/en'],
        ];
