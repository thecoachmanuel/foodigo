                                    ...
                                    <table class="crancy-table__main crancy-table__main-v3 dataTable no-footer" id="dataTable">
                                        ...
                                        @foreach ($products as $index => $product)
                                            ...
                                            <tr class="odd">
                                                ...
                                                <td class="crancy-table__column-2 crancy-table__data-2">
                                                    <h4 class="crancy-table__product-title">{{ html_decode($product?->restaurant?->restaurant_name) }}</h4>
                                                </td>
                                                ...
                                                <td class="crancy-table__column-2 crancy-table__data-2">
                                                    <a href="{{ route('admin.product.edit', ['product' => $product->id, 'lang_code' => admin_lang()] ) }}" class="crancy-btn"><i class="fas fa-edit"></i> {{ __('translate.Edit') }}</a>
