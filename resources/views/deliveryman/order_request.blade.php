                                ...
                                <div class="d-flex align-items-center gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p class="m-0 text-white-50" style="font-size:12px;">
                                            {{ __('translate.First delivery partner to accept claims the order. Rejections are isolated to your account.') }}
                                        </p>
                                    </div>
                                </div>
...
@push('js_section')
    <script>
        ...
        function confirmClaim(e, form) {
            ...
            btn.innerHTML = '<i class="fas fa-spinner fa-spin"></i> {{ __("translate.Claiming...") }}';
            btn.disabled = true;
            return true;
        }
