                    ...
                    <div class="crancy-ecom-card crancy-ecom-card__v2">
                        <div class="flex-main">
                            ...
                            <span>
                                <div class="d-inline-flex justify-content-center align-items-center bg-success-white rounded-circle grid-icon-size text-primary">
                                    <svg width="28" height="28" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M22.1667 9.33337H5.83333C4.54467 9.33337 3.5 10.378 3.5 11.6667V21C3.5 22.2887 4.54467 23.3334 5.83333 23.3334H22.1667C23.4553 23.3334 24.5 22.2887 24.5 21V11.6667C24.5 10.378 23.4553 9.33337 22.1667 9.33337Z" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                        <path d="M18.6667 9.33333V7C18.6667 5.76232 18.175 4.57534 17.2998 3.70017C16.4247 2.825 15.2377 2.33333 14 2.33333C12.7623 2.33333 11.5753 2.825 10.7002 3.70017C9.825 4.57534 9.33333 5.76232 9.33333 7V9.33333" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                        <path d="M14 15.1667V17.5" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                    </svg>
                                </div>
                            </span>
                        </div>
