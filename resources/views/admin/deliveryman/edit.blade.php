...
@section('title')
    <title>{{ __('translate.Edit Deliveryman') }}</title>
@endsection
@section('body-header')
    <h3 class="crancy-header__title m-0">{{ __('translate.Edit Deliveryman') }}</h3>
    <p class="crancy-header__text">{{ __('translate.Dashboard') }} >> {{ __('translate.Edit Deliveryman') }}</p>
@endsection
                ...
                <div class="col-12">
                    <div class="crancy-body">
                        ...
                        <div class="crancy-dsinner">
                            <form action="{{ route('admin.deliveryman-update', $deliveryman->id) }}" enctype="multipart/form-data" method="POST">
                                @csrf
