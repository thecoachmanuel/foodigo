...
@section('title')
    <title>{{ __('translate.Create Deliveryman') }}</title>
@endsection
@section('body-header')
                ...
                <div class="col-12">
                    <div class="crancy-body">
                        ...
                        <div class="crancy-dsinner">
                            <form action="{{ route('admin.deliveryman-store') }}" enctype="multipart/form-data" method="POST">
                                @csrf
                                <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="crancy__item-form--group mg-top-25">
                                                        ...
                                                        <div class="position-relative">
                                                            <input class="crancy__item-input has-password-toggle" type="password" name="password" required autocomplete="new-password">
