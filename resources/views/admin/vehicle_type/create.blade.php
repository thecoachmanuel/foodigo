...
@section('title')
    <title>{{ __('translate.Create Vehicle Type') }}</title>
@endsection

@section('body-header')
    <h3 class="crancy-header__title m-0">{{ __('translate.Create Vehicle Type') }}</h3>
    <p class="crancy-header__text">{{ __('translate.Manage Delivery Man') }} >> {{ __('translate.Create Vehicle Type') }}</p>
@endsection
                                    ...
                                    <div class="col-12 mg-top-30">
                                        ...
                                        <div class="crancy-product-card">
                                            <div class="create_new_btn_inline_box">
                                                <h4 class="crancy-product-card__title">{{ __('translate.Create Vehicle Type') }}</h4>
