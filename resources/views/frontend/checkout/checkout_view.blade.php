                    ...
                    <div class="col-xxl-8 col-xl-8">
                        <form action="{{ route('continue.order') }}" class="pickup_item_from" method="post"
                            ...
                            <div class="delivery">
                                ...
                                <input type="hidden" name="address_id" id="addresss">
                                            ...
                                            <div class="row">
                                                ...
                                                @foreach ($addresses as $key => $address)
                                                    <div class="col-sm-6 col-xxl-6 mb-4">
                                                        <div class="dashboard_address_item single_address"
                                                            ...
                                                            <div class="dashboard_address_inner">
                                                                <ul class="address">
                                                                    <li><a href="javascript:;">{{ __('translate.Name') }} :
                                                                            <span> {{ $address->name }}</span></a>
                                                                    </li>
                                                                    <li><a href="javascript:;">{{ __('translate.Email') }}
                                                                            :
                                                                            <span>{{ $address->email }}</span> </a></li>
                                                                    <li><a href="javascript:;">{{ __('translate.Phone') }}
                                                                            :
                                                                            <span> {{ $address->phone }}</span></a>
                                                                    </li>
                                                                    </li>
                                                                    <li><a href="javascript:;">{{ __('translate.Address') }} :
                                                                            <span>{{ $address->address }}</span> </a>
                                                                    </li>
                                                                </ul>
                                                            </div>
                                                        </div>
                    ...
                    <div class="col-xxl-4 col-xl-4">
                        <div class="order_summery_box">
                            ...
                            <ul class="order_summery_list">
                                ...
                                @if (!Session::has('applied_coupon') && Auth::check())
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form class="address_form_main" method="post" action="{{ route('user.address-store') }}">
                                ...
                                <div class="address_form_item">
                                    <div class="address_form_inner">
                                        <label for="" class="form-label">{{ __('translate.Delivery Type') }}</label>
...
@push('js_section')
    <script>
        ...
        $(document).ready(function() {
            ...
            $('.address_form_main').on('submit', function(e) {
